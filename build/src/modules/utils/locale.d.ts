...
declare const init: (msNames: string, namespaceList: string[], requestTopic?: string, uri?: string, timeout?: number) => void;
declare const initInternal: (msNames: string, namespaceList: string[], requestTopic?: string, uri?: string, timmeout?: number) => void;
